...
const SecondRoute = () => (
  <RouteContainer>
    ...
    <JBButton title="대전출장빵구" onPress={() => download('tel: 01034683806')} underline />
    <JBButton title="비파괴검사기관" onPress={() => download('tel: 01033334707')} underline />
    <JBButton title="수산중공업" onPress={() => download('tel: 0313505277')} underline />
    <JBButton title="서울출장빵구" onPress={() => download('tel: 026884067')} underline />
    <JBButton
      title="비파괴검사기관(착한가격)"
      onPress={() => download('tel: 01089051331')}
      underline
    />
    <JBButton title="화산로프" onPress={() => download('tel: 0226773936')} underline />
  </RouteContainer>
);
