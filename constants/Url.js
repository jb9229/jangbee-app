// const SERVER_URL = 'http://10.65.19.109/api/v1/';
...
module.exports = {
  ...
  JBSERVER_WORK_FIRM_OPENWORK: `${SERVER_URL}works/firm/openwork`,
  JBSERVER_WORK_FIRM_MATCHEDWORK: `${SERVER_URL}works/firm/matchedwork`,
