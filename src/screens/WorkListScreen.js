  ...
  render() {
    ...
    const renderOpenWorkList = () => (
      <ClientOpenWorkList
        ...
        editWork={work =>
          this.setState({ editWork: work, isVisibleEditWorkModal: true })
        }
      />
    );
    ...
    const renderMatchedWorkList = () => (
      <ClientMatchedWorkList
        ...
        estimateFirm={workId =>
          this.setState({ isVisibleEstimateModal: true, estiWorkId: workId })
        }
        openMatchedFirmInfo={matchedAccId =>
          this.setState({
            matchedfirmAccId: matchedAccId,
    ...
    return (
      <View style={styles.Container}>
        ...
        <JBButton
          title="일감 등록하기"
          onPress={() =>
            navigation.navigate('WorkRegister', { firmRegister: false })
          }
          size="full"
          Primary
        />
